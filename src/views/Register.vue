...
import router from "@/router";
  ...
  const rules = reactive({
    ...
    confirmPassword: [
      ...
      { min: 3, max: 20, message: '密码长度在6-8位之间', trigger: 'blur' },
    ],
  })
...
<template>
  <div style="height: 100vh; overflow: hidden; background-color: aliceblue">
    <div style="width: 100%; background-color: rgba(65, 105, 225,.1);padding: 15px 30px; color: dodgerblue; font-size: 25px;font-weight: bolder; position: absolute">SmartParking</div>
    <div style="display: flex; width: 50%; margin: 120px auto; background-color: white;
      ...
      <div style="padding:30px">
        <img src="../assets/bg1.jpg" alt="" style="width: 100%; margin-top: 50px">
      </div>
      <div>
